...
class CreateNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvDateTime.text =
            ("Terakhir diubah : " + SimpleDateFormat("dd MMMM yyyy", Locale.getDefault()).format(
                Date()
            ))
        ...
        fabSaveNote.setOnClickListener(View.OnClickListener {
            ...
            } else if (editTextSubTitle.text.toString().isEmpty() && editTextDesc.getText()
                    .toString().isEmpty()
            ) {
                Toast.makeText(
                    this@CreateNoteActivity,
            ...
            modelNote.title = editTextTitle.text.toString()
            modelNote.subTitle = editTextSubTitle.text.toString()
            modelNote.noteText = editTextDesc.text.toString()
            modelNote.dateTime = tvDateTime.text.toString()
            modelNote.imagePath = selectImagePath

            if (tvUrlNote.visibility == View.VISIBLE) {
                modelNote.url = tvUrlNote.text.toString()
